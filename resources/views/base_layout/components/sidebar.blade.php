        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item start ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{trans('sidebar.students')}}</span>
                ...
                <ul class="sub-menu">
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            ...
                            <span class="title">{{trans('sidebar.all_students')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-clock-o"></i>
                            <span class="title">{{trans('sidebar.pending_students')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-eye"></i>
                            <span class="title">{{trans('sidebar.student_pass_reset')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-ban"></i>
                            <span class="title">{{trans('sidebar.disabled_students')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-trash"></i>
                            <span class="title">{{trans('sidebar.deleted_students')}}</span>
                        </a>
                    </li>
                </ul>
            </li> 
            ...
            <li class="nav-item start ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{trans('sidebar.posts')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item start ">
                        <a href="/post" class="nav-link ">
                            <i class="fa fa-list"></i>
                            <span class="title">{{trans('sidebar.all_posts')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="/post/create" class="nav-link ">
                            <i class="fa fa-pencil"></i>
                            <span class="title">{{trans('sidebar.create_post')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="/post/pending" class="nav-link ">
                            <i class="fa fa-clock-o"></i>
                            <span class="title">{{trans('sidebar.pending_post')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="/post/all/edit" class="nav-link ">
                            <i class="fa fa-ban"></i>
                            <span class="title">{{trans('sidebar.control')}}</span>
                        </a>

                    <li class="nav-item start ">
                        <a href="/post/reporte" class="nav-link ">
                            <i class="fa fa-close"></i>
                            <span class="title">{{trans('sidebar.reported_post')}}</span>
                        </a>
                    </li>
                </ul>
            </li> 
            ...
            <li class="nav-item start ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">{{trans('sidebar.comments')}}</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-list"></i>
                            <span class="title">{{trans('sidebar.all_comments')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-clock-o"></i>
                            <span class="title">{{trans('sidebar.pending_comments')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-ban"></i>
                            <span class="title">{{trans('sidebar.disabled_comments')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-trash"></i>
                            <span class="title">{{trans('sidebar.deleted_comments')}}</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="{{--route('')--}}" class="nav-link ">
                            <i class="fa fa-close"></i>
                            <span class="title">{{trans('sidebar.reported_comments')}}</span>
                        </a>
                    </li>
                </ul>
            </li>            
